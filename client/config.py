...
FILE_MODE: bool = True  # Parse from file if True, else from microphone.
...
SPECIFIC_THRESHOLD: float     = 0.30 # Minimum score to categorize a more specialized general request or question.
